        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{URL::to($v_published_product->product_image)}}" style="height: 250px;" />
                    ...
                    <div class="product-overlay">
                        <div class="overlay-content">
                            <h2>{{ $v_published_product->product_price }} Tk.</h2>
                            <p>{{ $v_published_product->product_name }}</p>
                            <a href="{{'/product-single-view/'.$v_published_product->product_id}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
                    </div>
            </div>
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="{{'/product-by-brand/'.$v_published_product->brand_id}}"><i class="fa fa-plus-square"></i>{{ $v_published_product->brand_name }}</a></li>
                    <li><a href="{{'/product-single-view/'.$v_published_product->product_id}}"><i class="fa fa-plus-square"></i>View Product</a></li>
                </ul>
            </div>
        </div>
    </div>
