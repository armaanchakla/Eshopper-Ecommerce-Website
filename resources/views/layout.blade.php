...
<head>
    ...
    <link rel="shortcut icon" href="{{URL::to('frontend/images/favicon.ico')}}">
...
<body>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                if ($customer_id != NULL){ ?>
                                    <li><a href="{{URL::to('/customer-account')}}"><i class="fa fa-user"></i> {{ Session::get('customer_name') }}</a></li>
                                <?php }else{ ?>
                    ...
                    <div class="left-sidebar">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            ?>
                                ...
                                <h4 class="panel-title"><a href="{{'/product-by-category/'.$v_category->category_id}}">{{ $v_category->category_name }}</a></h4>
                                </div>
                                </div>
                            <?php
                            }
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            ?>
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{'/product-by-brand/'.$v_brand->brand_id}}"> <span class="pull-right">(50)</span>{{ $v_brand->brand_name }}</a></li>
                                </ul>
                            <?php
                            }
                            ?>   
    ...
    <footer id="footer"><!--...................................................Footer.............................................-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-right">Copyright © 2020 E-SHOPPER Inc. All rights reserved.</p>
                    {{-- <p class="pull-left">Designed by <span><a target="_blank" href="http://www.themeum.com">Themeum</a></span></p> --}}
                </div>
            </div>
        </div>
