...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Admin Layout | E-Shopper</title>
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>E-Shopper Admin Dashboard</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							<a class="dropmenu"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Category </span></a>
							<ul>
						...
						<li>
							<a class="dropmenu"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Brand </span></a>
							<ul>
						...
						<li>
							<a class="dropmenu"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Product </span></a>
							<ul>
						...
						<li>
							<a class="dropmenu"><i class="icon-folder-close-alt"></i><span class="hidden-tablet"> Slider </span></a>
							<ul>
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="{{url('/admin-dashboard')}}" alt="Bootstrap Admin Templates">E-Shopper</a></span>
		</p>
	...
	{{-- Delete Confirmation CDN and Javascript --}}
